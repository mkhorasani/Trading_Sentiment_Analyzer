...
## Summary
Trading Sentiment Analyzer will analyze any trading instrument by retrieving archived news articles from the internet and will subsequently compute a normalized score for the sentiment of that instrument.
